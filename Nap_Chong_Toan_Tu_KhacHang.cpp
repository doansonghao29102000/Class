...
class Khach_Hang
{
	private:
      ...
      public:
          ...
          friend bool operator <(Khach_Hang &a, Khach_Hang &b);
          string getHo_Khau();	
};
...
bool operator < (Khach_Hang &a, Khach_Hang &b){
...
int main(){
	...
	cout<<"/n_______Danh Sach Thong Tin Khach Hang Thu _______"<<endl;
	for(int i=0;i<n;i++){
		cout<<x[i]<<endl;
	}
	cout<<"/n_______Danh Sach Khac Hang Co Ho Khau Ha Noi _______"<<endl;
	for(int i=0;i<n;i++){
	...
	cout<<"/n_______Danh Sach Khac Hang Sap Xep Theo Do Tuoi _______"<<endl;
	for(int i=0;i<n;i++){
		cout<<x[i]<<endl;
	}
	return 0;
